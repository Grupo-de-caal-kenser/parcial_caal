...
$router->get('/permisos/datatable', [RolController::class,'datatable']);
$router->post('/API/permisos/guardar', [RolController::class,'guardarAPI'] );
...
$router->post('/API/permisos/modificar', [RolController::class,'modificarAPI'] );
$router->post('/API/permisos/eliminar', [RolController::class,'eliminarAPI'] );
$router->get('/API/permisos/buscar', [RolController::class,'buscarAPI'] );
